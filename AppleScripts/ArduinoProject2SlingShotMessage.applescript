...
*)
	...
	on Çevent ichthe15È given Çclass heprÈ:theBuddy, Çclass hectÈ:theChat, Çclass heedÈ:eventDescription
		#		say eventDescription
	end Çevent ichthe15È
	...
	on Çevent ichthe16È given Çclass heedÈ:eventDescription
		#		say eventDescription
	end Çevent ichthe16È
